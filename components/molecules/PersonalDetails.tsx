...
const AGE_RANGES = ["18-25", "26-35", "36-45", "46-55", "56-65", "66+"];

const DENOMINATIONS = ["Sunni", "Shia", "Sufi", "Other", "Prefer not to say"];
    ...
    <View style={styles.container}>
      ...
      {isOnboardingDataSynced && (ageRange || denomination) && (
        <View style={styles.infoCard}>
          ...
          >
            We've pre-filled some details from your initial setup. Feel free to
            edit or add more information.
          </Typography>
        </View>
      )}

      {renderField("Age Range", ageRange, () => setShowAgeModal(true))}
