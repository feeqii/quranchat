...
export const DailyStreakCalendarOrganism: React.FC<
  DailyStreakCalendarOrganismProps
> = ({ onDayPress }) => {
  const {
    streakDays,
    journeyCompleted,
  ...
  const renderDay = (day: number) => {
    ...
    const hasReflection =
      getReflectionForDate(dateStringForReflection) !== null;
      ...
      <View key={day} style={styles.dayContainer}>
        ...
        >
          <Typography
            ...
            style={[
              styles.dayNumber,
              (completed || today || selected || hasReflection) &&
                styles.dayNumberBold,
            ]}
          >
            {day}
          </Typography>
      ...
      >
        <View style={styles.calendarHeader}>
          ...
          <View style={styles.streakInfo}>
            ...
            >
              {streakDays.length} day{streakDays.length !== 1 ? "s" : ""} this
              month
            </Typography>
          </View>
        </View>
